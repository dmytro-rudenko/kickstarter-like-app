...
describe("Campaigns", () => {
	...
	*/
	...
	// 	await campaign.methods.createRequest(DESC, "100", accounts[1]).send({
	// 		from: accounts[0],
	// 		gas: "1000000",
	// 	});

	// 	const request = await campaign.methods.requests(0).call(); // something wrong right here
